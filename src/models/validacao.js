class Validacao {
        ...
        objetoArr.forEach((elemento) => {
            ...
            switch (chave) {
                ...
                case "senha":
                    ...
                    break;
                case 'email':
                    validados.push(this.validaEmail(valor.value))
                    if (!this.validaEmail(valor.value)) valor.style.color = 'red'
                    if (this.validaEmail(valor.value)) valor.style.color = 'green'
                    break;
                case 'cpf':
    ...
    static verificaCampos(pagina) {
        if (Validacao.validacoes(pagina)) {
